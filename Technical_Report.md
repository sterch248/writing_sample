...
If this assumption is true, that investors emotions are based on changes in Stock Prices, then using the Stock Market to predict investor sentiment is a possibility.
